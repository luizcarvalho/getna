...
uso de Templates.
 ...
 Requires::	Ruby 1.8 ou Superior

 License::	Copyright (c) 2003 Luiz Arão A. Carvalho. Lançadp sobre as Regras da Lisença MIT. 
...
nao pensei em uma maneira dele advinhar isso =)[alias ele meio que adivinha, caso não seja 
...
[url]http://maxonrails.wordpress.com/2008/09/08/getna-feedback/[/url]
