...
Existem 3 maneiras fáceis de fazer isso, a primeira mais trivial:
...
As outras 2 necessitam da instalação do git (http://git.or.cz/) 
...
http://www.redrails.com.br/2008/09/getna-feedback/

== Agradecimentos
Silvio Fernandes ( Exxpert Soad ) <http://github.com/exxpert>
e a Galera do rails-br <http://groups.google.com/group/rails-br>
